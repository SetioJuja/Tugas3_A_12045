...
""", unsafe_allow_html=True)
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 2045</h1>", unsafe_allow_html=True) 
...
if uploaded_file is not None:
    ...
    model_directory = r"C:\Users\ASUS\Downloads\Supervised Learning (Praktek)\Model Suprevised Learning (Praktek)\Tugas3_A_12045"
